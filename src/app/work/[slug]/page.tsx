...
import {
  ...
  AnimatedMoreWorkCard,
} from "@/components/ProjectDetailAnimations";
    ...
    sections: [
      {
        ...
        richContent: (
          <>
            <h2 style={{ fontSize: 36, fontWeight: 300, marginBottom: 15, marginTop: 0, letterSpacing: "-2px" }}>
              Problem
            </h2>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 30 }}>
              Everyone is waiting for AGI to understand their business. <strong>But it never will.</strong>
            </p>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 30 }}>
              Because:
            </p>
            <ul style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 30, listStyleType: "disc" }}>
      ...
      },
      {
        ...
        richContent: (
          <>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 20, marginTop: 0 }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 0, marginTop: 0 }}>
    ...
    sections: [
      {
        ...
        richContent: (
          <>
            ...
            <ul style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 0, listStyleType: "disc" }}>
    ...
    sections: [
      {
        ...
        richContent: (
          <>
            ...
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 20 }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 15 }}>
              In its first phase, our product helps brands:
            </p>
            <ul style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 20, listStyleType: "disc" }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 0 }}>
      ...
      },
      {
        ...
        richContent: (
          <>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 30, marginTop: 0 }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 500, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 10 }}>
              Problem:
            </p>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 15 }}>
            ...
            <img src="/images/shopswap/22.jpg" alt="ShopSwap - Onboarding" style={{ width: "100%", height: "auto", display: "block", marginTop: 30, marginBottom: 30 }} />
            <h2 style={{ fontSize: 36, fontWeight: 300, marginBottom: 15, marginTop: 0, letterSpacing: "-2px" }}>
            ...
            <img src="/images/shopswap/23.gif" alt="ShopSwap - Pre-Generated Task List" style={{ width: "100%", height: "auto", display: "block", marginTop: 30, marginBottom: 30 }} />
            <h2 style={{ fontSize: 36, fontWeight: 300, marginBottom: 15, marginTop: 0, letterSpacing: "-2px" }}>
            ...
            <img src="/images/shopswap/24.jpg" alt="ShopSwap - Landing Page Customization Tool" style={{ width: "100%", height: "auto", display: "block", marginTop: 30, marginBottom: 30 }} />
            <h2 style={{ fontSize: 36, fontWeight: 300, marginBottom: 15, marginTop: 0, letterSpacing: "-2px" }}>
            ...
            <img src="/images/shopswap/25.jpg" alt="ShopSwap - Campaign Broadcasts" style={{ width: "100%", height: "auto", display: "block", marginTop: 30, marginBottom: 0 }} />
          </>
        ),
        columns: 2,
        images: [],
  ...
  foodies: {
    ...
    sections: [
      ...
      },
      {
        ...
        richContent: (
          <>
            ...
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 15 }}>
              <strong>User Interviews:</strong> I created an <a href="https://docs.google.com/document/d/1ymJgkmwdDn5NFk-Wt25vW4x1c-fhkjprrQMeeFvn-x0/edit?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline" }}>interview protocol</a> to ask potential users. The high-level goals of this study were:
            </p>
            <ul style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 20, listStyleType: "disc" }}>
            ...
            <ol style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 20, listStyleType: "decimal" }}>
        ...
        columns: 4,
        images: [
          "07.png", "02.png", "04.png", "03.png",
          "08.png", "09.png", "05.png", "06.png",
        ],
      },
      {
      ...
      },
      {
        ...
        richContent: (
          <>
            <p style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 15, marginTop: 0 }}>
    ...
    sections: [
      {
        ...
        richContent: (
          <>
            ...
            <ol style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 30, listStyleType: "decimal" }}>
            ...
            <ol style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", paddingLeft: 20, marginBottom: 0, listStyleType: "decimal" }}>
              <li style={{ marginBottom: 10 }}><strong>Redesign the nav bar:</strong> Consolidate main features into five tabs for easier access.</li>
              <li style={{ marginBottom: 10 }}><strong>Redesign buttons and icons:</strong> Enlarge touch areas to improve tapping accuracy.</li>
              <li style={{ marginBottom: 10 }}><strong>Redesign the event creation page:</strong> Reduce the number of steps to minimize time to completion.</li>
              <li style={{ marginBottom: 10 }}><strong>Redesign sorting and filtering features:</strong> Make these tools clearer and more intuitive.</li>
              <li style={{ marginBottom: 10 }}><strong>Redesign event cards on the homepage:</strong> Display only necessary information to create a cleaner and more focused layout.</li>
              <li style={{ marginBottom: 10 }}><strong>Enhance event category details:</strong> Reference current event planning competitors for inspiration.</li>
              <li style={{ marginBottom: 10 }}><strong>Rephrase description texts in the event creation form:</strong> Simplify the language to improve user understanding.</li>
              <li style={{ marginBottom: 10 }}><strong>Enlarge text areas</strong> to improve readability.</li>
              <li style={{ marginBottom: 0 }}><strong>Change the current font:</strong> Switch to a more common mobile app font, Open Sans, to increase the app{"\u2019"}s credibility.</li>
            </ol>
          </>
        ),
        columns: 4,
        images: ["05.png", "04.png", "02.png", "03.png"],
      },
      {
  ...
  return (
    <div className="page-padding">
      ...
      <AnimatedHeadline>
        ...
        >
          <h1 className="project-headline" style={{ fontSize: 48, fontWeight: 300, lineHeight: 1.2, letterSpacing: "-2px", margin: 0 }}>
            {details.headline}
          </h1>
          <span className="headline-date" style={{ fontSize: 12, color: "var(--gray-mid)", flexShrink: 0, whiteSpace: "nowrap", lineHeight: 1.3, paddingBottom: "0.25em" }}>
            {details.date}
          </span>
        </div>
      </AnimatedHeadline>
      ...
      <AnimatedInfoRow>
        <div className="info-row">
          <div>
            ...
            <div style={{ fontSize: 14, letterSpacing: "0px", lineHeight: 1.4 }}>{details.summary}</div>
          </div>
          <div>
            <div className="info-label">Keywords</div>
            {details.keywords.map((k) => (
              <div key={k} style={{ fontSize: 12, letterSpacing: "0px", lineHeight: 1.3, marginBottom: 4 }}>
                — {k}
              </div>
            ))}
          </div>
          <div>
            ...
            {details.tools.map((t) => (
              <div key={t} style={{ fontSize: 12, letterSpacing: "0px", lineHeight: 1.3, marginBottom: 4 }}>
                — {t}
              </div>
            ))}
          </div>
                  ...
                  {section.richContent ? (
                    ...
                    <div>
                      {section.description.split("\n\n").map((para, pi) => (
                        <p key={pi} style={{ fontSize: 14, fontWeight: 300, lineHeight: 1.3, letterSpacing: "0px", marginBottom: 0, marginTop: pi > 0 ? 20 : 0 }}>
                          {para}
                        </p>
                      ))}
                    </div>
      ...
      <div style={{ padding: "60px 0" }}>
        <div className="page-title" style={{ marginBottom: 30 }}>
          <AnimatedMoreWorkTitle />
        </div>
        <div
          style={{
        ...
        >
          {(() => {
            ...
            return next;
              ...
              <AnimatedMoreWorkCard key={p.slug} index={idx}>
                <Link
                  href={`/work/${p.slug}`}
